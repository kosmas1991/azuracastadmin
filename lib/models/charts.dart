...
class Charts {
    ...
    factory Charts.fromJson(Map<String, dynamic> json) => Charts(
        ...
        dayOfWeek: json["day_of_week"] == null ? null : DayOfWeek.fromJson(json["day_of_week"]),
...
class Daily {
    ...
    factory Daily.fromJson(Map<String, dynamic> json) => Daily(
        metrics: json["metrics"] == null ? [] : List<DailyMetric>.from(json["metrics"]!.map((x) => DailyMetric.fromJson(x))),
        alt: json["alt"] == null ? [] : List<Alt>.from(json["alt"]!.map((x) => Alt.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "metrics": metrics == null ? [] : List<dynamic>.from(metrics!.map((x) => x.toJson())),
        "alt": alt == null ? [] : List<dynamic>.from(alt!.map((x) => x.toJson())),
    };
}
...
class Alt {
    ...
    factory Alt.fromJson(Map<String, dynamic> json) => Alt(
        label: json["label"],
        values: json["values"] == null ? [] : List<AltValue>.from(json["values"]!.map((x) => AltValue.fromJson(x))),
    );
...
class DailyMetric {
    ...
    factory DailyMetric.fromJson(Map<String, dynamic> json) => DailyMetric(
        ...
        type: json["type"],
        fill: json["fill"],
        data: json["data"] == null ? [] : List<DataPoint>.from(json["data"]!.map((x) => DataPoint.fromJson(x))),
    );
...
class DayOfWeek {
    ...
    factory DayOfWeek.fromJson(Map<String, dynamic> json) => DayOfWeek(
        ...
        metrics: json["metrics"] == null ? [] : List<DayOfWeekMetric>.from(json["metrics"]!.map((x) => DayOfWeekMetric.fromJson(x))),
        alt: json["alt"] == null ? [] : List<Alt>.from(json["alt"]!.map((x) => Alt.fromJson(x))),
    );
...
class DayOfWeekMetric {
    ...
    factory DayOfWeekMetric.fromJson(Map<String, dynamic> json) => DayOfWeekMetric(
        label: json["label"],
