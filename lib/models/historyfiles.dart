...
List<HistoryFiles> historyFilesFromJson(String str) => List<HistoryFiles>.from(
    json.decode(str).map((x) => HistoryFiles.fromJson(x)));

String historyFilesToJson(List<HistoryFiles> data) =>
